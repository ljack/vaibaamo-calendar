...
export default function EditRecapTab({
    recap_markdown,
    handleChange,
    mediaAssets,
    uploading,
    ...
    const recapAssets = mediaAssets.filter(m => m.section === 'recap')
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-96">
                    ...
                    <div className="border rounded-md p-4 overflow-auto prose prose-sm bg-gray-50 h-full">
                        <ReactMarkdown remarkPlugins={[remarkBreaks]} rehypePlugins={[rehypeSanitize]}>
                            {recap_markdown || `*${t('events.edit.preview')}*`}
                        </ReactMarkdown>
                    </div>
                </div>
            </div>
