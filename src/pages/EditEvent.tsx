                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-96">
                                ...
                                <div className="border rounded-md p-4 overflow-auto prose prose-sm bg-gray-50 h-full">
                                    <ReactMarkdown remarkPlugins={[remarkBreaks]} rehypePlugins={[rehypeSanitize]}>{formData.plan_markdown || `*${t('events.edit.preview')}*`}</ReactMarkdown>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-96">
                                ...
                                />
                                <div className="border rounded-md p-4 overflow-auto prose prose-sm bg-gray-50 h-full">
                                    <ReactMarkdown remarkPlugins={[remarkBreaks]} rehypePlugins={[rehypeSanitize]}>{formData.recap_markdown || `*${t('events.edit.preview')}*`}</ReactMarkdown>
                                </div>
                            </div>
                        </div>
