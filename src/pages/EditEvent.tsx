...
import EditAdminsTab from '../components/EventEdit/EditAdminsTab'
        ...
        <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex border-b border-gray-200 mb-6">
                ...
                <button
                    ...
                    className={`py-2 px-4 border-b-2 font-medium text-sm ${activeTab === 'admins' ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
                >
                    {t('events.edit.tabAdmins')}
                </button>
            </div>
